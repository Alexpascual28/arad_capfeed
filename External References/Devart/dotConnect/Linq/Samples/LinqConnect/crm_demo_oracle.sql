-- ALTER TABLE "Company" DROP CONSTRAINT "Company_PrimaryContact";
...
CREATE TABLE "Person Contact" (
  ...
  CONSTRAINT "PersonContact_Company" FOREIGN KEY ("CompanyID") REFERENCES "Company" ("CompanyID")
);
...
CREATE TABLE "Orders" (
  ...
  "Freight" number(10,2),
  "ShipDate" date,
  "ShipCompanyID" number(9),
  "Discount" number(10,2),
  PRIMARY KEY  ("OrderID"),
  -- An association to the Company table (to the customer company)
  CONSTRAINT "Orders_Company" FOREIGN KEY ("CompanyID") REFERENCES "Company" ("CompanyID"),
  -- An association to the Person Contact table (to the person related to this order)
  CONSTRAINT "Orders_Contact" FOREIGN KEY ("ContactID") REFERENCES "Person Contact" ("ContactID"),
  -- An association to the Company table (to the shipping company)
  CONSTRAINT "Orders_ShipCompany" FOREIGN KEY ("ShipCompanyID") REFERENCES "Company" ("CompanyID")
);
...
CREATE TABLE "Order Details" (
  ...
  CONSTRAINT "OrderDetails_Product" FOREIGN KEY ("ProductID") REFERENCES "Products" ("ProductID")
);
